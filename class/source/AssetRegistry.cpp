...
// std::vector<ShaderProgramFilePaths> AssetRegistry::loadShaderPathSet(std::vector<ShaderProgramFilenameStrings> shaderFilenames)
// {
...
std::vector<std::filesystem::path> AssetRegistry::getAllFilesOfType(std::filesystem::path directory, std::vector<std::string> fileTypes)
{
    ...
    for (const auto& file : std::filesystem::directory_iterator(directory))
    {
        ...
        {
            if (std::find(fileTypes.begin(), fileTypes.end(), file.path().extension().string()) != fileTypes.end())
            {
                #ifdef ENABLE_DEBUG_MESSAGES
                    std::cout << "INFO::AssetRegistry::getAllFilesOfType::File found: " << file.path().filename() << std::endl;
                #endif
...
// void AssetRegistry::checkPathsAndStore(ShaderProgramFilePaths& foundPaths)
// {
...
// ShaderProgramFilePaths AssetRegistry::loadShaderPaths(ShaderProgramFilenameStrings sourceFileNames)
// {
...
// void AssetRegistry::populateTexturePaths(std::filesystem::path textureFolderPath)
// {
...
// void AssetRegistry::refreshTexturePaths()
// {
